...
export const sections: LegalSection[] = [
  {
    ...
    flag: (
      <p>
        ...
        characterization given the client agreements as written.
      </p>
    ),
  },
  {
    ...
    flag: (
      <>
        ...
        <p>
          ...
          honor becomes a documented breach of our own policy, and it is the first
        ...
        <p>
          ...
          might have wanted in our defense. The 24-month record is what does the
